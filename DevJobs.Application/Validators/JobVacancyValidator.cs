    ...
    public class JobVacancyValidator : AbstractValidator<JobVacancy>
    {
        public JobVacancyValidator()
        {
            RuleFor(jv => jv.Title)
                ...
                .MaximumLength(100).WithMessage("Título pode conter no máximo 150 caracteres.")
                .MinimumLength(30).WithMessage("Título deve conter no mínimo 30 caractes.");
            RuleFor(jv => jv.Description)
                ...
                .MaximumLength(300).WithMessage("A descrição pode conter no máximo 150 caracteres.")
                .MinimumLength(30).WithMessage("A descrição deve conter no mínimo 30 caractes.");
            RuleFor(jv => jv.Company)
                ...
                .MinimumLength(30).WithMessage("Nome da companhia deve conter no mínimo 30 caractes.");
            RuleFor(jv => jv.SalaryRange)
                ...
                .MaximumLength(50).WithMessage("O range salarial pode conter no máximo 150 caracteres.")
